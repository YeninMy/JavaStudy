...
public class Main {
    public static void main(String[] args) {
        ...
        Lecture l1 = new Lecture(1, "Enum",new Teacher(1,"Yuriy", "yuriy@gmail.com"));
        Lecture l2 = new Lecture(2, "Arrays",new Teacher(2,"Vlad", "vlad@gmail.com"));
        Lecture l3 = new Lecture(3, "List",new Teacher(3,"Andriy", "dron.gmail.com"));
