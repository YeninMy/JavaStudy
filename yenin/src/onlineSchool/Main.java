...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        LogService.writeLogs(persons.get(1),Level.INFO);
        ...
        LogService.writeLogs(persons.get(3),Level.INFO);
        ...
        homeworks.get(0).setAdditionalMaterials(new AdditionalMaterials(0, "Arrays Tutorial",
                ResourceType.VIDEO));
        LogService.writeLogs(homeworks.get(0),Level.INFO);
        ...
        LogService.writeLogs(additionalMaterialsList.get(1),Level.INFO);
        ...
        homeworks.get(2).setAdditionalMaterials(new AdditionalMaterials(2, "Інтерфейс Tutorial",
                ResourceType.BOOK));
        LogService.writeLogs(homeworks.get(2),Level.INFO);
